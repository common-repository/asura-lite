...
return [
    ...
    */
    ...
    'app_type' => function_exists('get_bloginfo') ? 'WordPress '. get_bloginfo( 'version' ) : env('BUGSNAG_APP_TYPE'),
    ...
    */
    ...
    'app_version' => @constant('THELOSTASURA') ?: env('BUGSNAG_APP_VERSION'),
    ...
    */
    ...
    'hostname' => function_exists('site_url') ? site_url() : env('BUGSNAG_HOSTNAME'),
