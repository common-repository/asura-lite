<div class="relative bg-gray-800">
    ...
    <div class="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div class="md:ml-auto md:w-1/2 md:pl-10">
            <h2 class="text-base font-semibold  tracking-wider text-gray-300">
                community.thelostasura.com
            </h2>
            <p class="mt-2 text-white text-3xl font-extrabold tracking-tight sm:text-4xl">
                We’re here to help
            </p>
            <p class="mt-3 text-lg text-gray-300">
                The Lost Asura Community is the home for WordPress fellas, join our great community now.
            </p>
            <div class="mt-8">
                <div class="inline-flex rounded-md shadow">
                    <a href="https://community.thelostasura.com/?utm_source=asura" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                        Visit the Community
